...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"autorestore" : "masi.reverb.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.5, 102.0, 221.0, 22.0 ],
...
,
					"style" : "",
					"text" : "pattrstorage masi.reverb @savemode 0",
					"varname" : "masi.reverb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 125.5, 72.0, 58.0, 22.0 ],
					"restore" : 					{
						"dampening" : [ 0.5 ],
						"diffusion" : [ 0.75 ],
						"level" : [ -11.957527 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 538.0, 223.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "del 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 538.0, 193.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.0, 302.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 488.0, 193.0, 39.0, 95.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 24.0, 33.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 144.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "prepend diff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 144.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "prepend damp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 144.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "prepend size"
				}
